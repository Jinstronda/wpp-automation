 ...
 */
function isPortugueseMobile(phone: string): boolean {
	const normalized = normalizePhoneNumber(phone);
 ...
 */
function extractValidPhones(primaryPhone: string, additionalPhones?: string): string[] {
	try {
 ...
 */
function cleanAndValidatePhones(leads: Lead[]): Lead[] {
